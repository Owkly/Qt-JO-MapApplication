...
# Template: app
# Command: /usr/bin/qmake -o Makefile Projet-Jeux-Olympiques.pro
#############################################################################
...
SOURCES       = main.cpp \
		mainwindow.cpp qrc_ressources.cpp \
		moc_mainwindow.cpp
OBJECTS       = main.o \
		mainwindow.o \
		qrc_ressources.o \
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		Projet-Jeux-Olympiques.pro mainwindow.hpp \
		lieu.hpp \
		epreuve.hpp main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = Map_JO
DESTDIR       = 
TARGET        = Map_JO
...
Map_JO: ui_mainwindow.h $(OBJECTS)  
...
distdir: FORCE
	...
	$(COPY_FILE) --parents mainwindow.hpp lieu.hpp epreuve.hpp $(DISTDIR)/
