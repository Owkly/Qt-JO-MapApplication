    ...
    void MainWindow::addEpreuveLabels(QVBoxLayout* infoLayout, const Epreuve& epreuve) {
    ...
    void MainWindow::addRestaurantLabels(QVBoxLayout* infoLayout, const Restaurant& restaurant) {
